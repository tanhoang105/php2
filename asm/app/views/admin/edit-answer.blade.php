          ...
          <div class="container-fluid">
               <div class="row">
                    ...
                    <div class="col col-lg-10 show-info">
                         ...
                         <div class="row">
                              <form action="<?= BASE_URL . 'answer-edit/luu?id_question=' . $_GET['id_question']  ?>" method="post">
                                   <div class="mb-3">
                                        <label for="tenQuiz" class="form-label">Nội dung câu trả lời cần chỉnh</label>
                                        <input type="text" class="form-control" id="tenQuiz" name="content" value="<?= $answer->content ?>">
                                   </div>
                                   <div class="mb-3">

                                        <input type="hidden" class="form-control" id="tenQuiz" name="id_answer" value="<?= $answer->id  ?>">
                                        <input type="hidden" class="form-control" id="tenQuiz" name="id_question" value="<?= $_GET['id_question'] ?>">
                                   </div>

                                   <div class="mb-3">
                                        <input type="radio" name="is_correct" id="" value="1" <?= $answer->is_correct == 1 ? 'checked' : '' ?>> đúng
                                        <input type="radio" name="is_correct" id="" value="0" <?= $answer->is_correct == 0 ? 'checked' : '' ?>> sai
