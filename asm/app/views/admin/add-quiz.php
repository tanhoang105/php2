          ...
          <div class="container-fluid">
               <div class="row">
                    ...
                    <div class="col col-lg-10 show-info">
                         ...
                         <div class="row">
                              <form action="<?= BASE_URL . 'quiz/luu-tao-moi?id=' . $_GET['id'] ?>" method="post">
                                   <div class="mb-3">
                                        <label for="tenQuiz" class="form-label">Tên quiz</label>
                                        <input type="text" class="form-control" id="tenQuiz" name="name">
                                   </div>

                                   <div class="mb-3">

                                        <input type="hidden" class="form-control" id="tenQuiz" name="subject_id" value="<?= $_GET['id'] ?>">
                                   </div>

                                   <div class="mb-3">
                                        <label for="tenQuiz" class="form-label">Thời gian làm Quiz</label>
                                        <input type="number" class="form-control" id="tenQuiz" name="duration_minutes">
                                   </div>

                                   <div class="mb-3">
                                        <label for="tenQuiz" class="form-label">Thời gian bắt đầu</label>
                                        <input type="date" class="form-control" id="tenQuiz" name="start_time">
                                   </div>

                                   <div class="mb-3">
                                        <label for="tenQuiz" class="form-label">Thời gian kết thúc</label>
                                        <input type="date" class="form-control" id="tenQuiz" name="end_time">
                                   </div>

                                   <div class="mb-3">
                                        <label for="tenQuiz" class="form-label">Trạng thái </label>
                                        <input type="number" class="form-control" id="tenQuiz" name="status">
                                   </div>
