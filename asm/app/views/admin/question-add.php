          ...
          <div class="container-fluid">
               <div class="row">
                    ...
                    <div class="col col-lg-10 show-info">
                         ...
                         <div class="row">
                              <form action="<?= BASE_URL . 'question-add/luu?quiz_id=' . $_GET['quiz_id'] ?>" method="post">
                                   <div class="mb-3">
                                        <label for="tenQuiz" class="form-label">Tên câu hỏi</label>
                                        <input type="text" class="form-control" id="tenQuiz" name="name">
                                   </div>

                                   <div class="mb-3">
                                        <!-- lấy id của quiz -->
                                        <input type="hidden" class="form-control" id="tenQuiz" name="quiz_id" value="<?= $_GET['quiz_id'] ?>">
                                   </div>
